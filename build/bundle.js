...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configStore = __webpack_require__(183);

	var _configStore2 = _interopRequireDefault(_configStore);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _configStore2.default)(); /* eslint no-unused-vars: 0 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _actions.fetchDataIfNeeded)(selectedCategory));
			}
		}, {
			...
			value: function componentWillReceiveProps(nextProps) {
				if (nextProps.selectedCategory !== this.props.selectedCategory) {
					...
					var selectedCategory = nextProps.selectedCategory;
			...
			key: 'handleChange',
			value: function handleChange(nextCategory) {
				this.props.dispatch((0, _actions.selectCategory)(nextCategory));
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					...
					items.length > 0 && _react2.default.createElement(
						'div',
						{ style: { color: isFetching ? 'red' : 'blue' } },
						_react2.default.createElement(_Posts2.default, { books: items })
					)
				);
			}
		}]);
	...
	App.propTypes = {
		selectedCategory: _react.PropTypes.string.isRequired,
		isFetching: _react.PropTypes.bool.isRequired,
		items: _react.PropTypes.array.isRequired,
		updateAt: _react.PropTypes.number,
		dispatch: _react.PropTypes.func.isRequired
	};

	function mapStateToProps(state) {
		var selectedCategory = state.selectedCategory;
		var dataByCategory = state.dataByCategory;

		var _ref = dataByCategory[selectedCategory] || {
			isFetching: true,
			items: []
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SELECT_CATEGORY = exports.RECEIVE_DATA = exports.REQUEST_DATA = undefined;
	...
	function shoudFetchData(state, category) {
		var books = state.dataByCategory[category];
		if (!books) {
			return true;
		}
		if (books.isFetching) {
	...
	function fetchData(category) {
		return function (dispatch) {
			...
			return (0, _isomorphicFetch2.default)('/books/' + category).then(function (response) {
				return response.json();
			}).then(function (json) {
				return dispatch(receiveData(category, json));
			});
		};
	}

	function fetchDataIfNeeded(category) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Picker = function (_Component) {
		...
		function Picker(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Picker).call(this, props));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configStore(initialStore) {
		var store = createStoreWithMiddleware(_reducers2.default, initialStore);
		return store;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function selectedCategory() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? 'computer' : arguments[0];
	...
	function dataByCategory() {
		...
		switch (action.type) {
			case 'REQUEST_DATA':
			case 'RECEIVE_DATA':
				return Object.assign({}, state, _defineProperty({}, action.category, setData(state[action.category], action)));
			default:
				return state;
		}
	}
